  ...
  return (
    <div className="flex flex-col space-y-4">
        <div className="flex justify-between gap-3 items-center py-4">
            <Link href={route("store.create")} className="flex items-center gap-3 p-2 bg-gray-800 text-white rounded-lg md:text-md text-xs md:w-32 text-center"><Plus /><span className="hidden md:block">Tambah</span></Link>
            {/*  */}
            <Input
            placeholder="Cari..."
            value={globalFilter ?? ""}
